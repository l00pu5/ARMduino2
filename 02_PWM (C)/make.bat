@echo off
arm-none-eabi-gcc -O0 -c -g -mcpu=cortex-m0 -mthumb -o main.o main.c
arm-none-eabi-gcc -O0 -c -g -mcpu=cortex-m0 -mthumb -o startup.o startup.c
arm-none-eabi-ld -Tstm32f070.ld -o firmware.elf startup.o main.o
